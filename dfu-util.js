      ...
      if (device) {
        ...
        navigator.usb
          ...
          .then(async (selectedDevice) => {
            ...
            /*try {
                            await device.getMemoryInfo();
                        } catch (err) {
                            console.warn("Memory info not found, setting manually");

                            // STM32H7 flash memory range example — adjust if needed
                            device.memoryInfo = {
                                segments: [
                                    {
                                        start: 0x08000000,   // STM32H7 internal flash start address
                                        end: 0x0807FFFF      // Example: 512 KB flash size
                                    }
                                ]
                            };
                        }*/
